...
gulp.task('scripts', (done) => {
	var jsFiles = [
'libs/plagins/jquery341.js',
'libs/plagins/page-scroll-to-id-master/js/minified/jquery.malihu.PageScroll2id.min.js',
'libs/plagins/magnific-popup/jquery.magnific-popup.min.js',
'libs/plagins/slick/slick.min.js',
'libs/common.js' // Always at the end
];
...
gulp.task('watch', done => {
	...
	//gulp.watch("*.html", gulp.series('code'));
		gulp.watch("*.php", gulp.series('code'));
...
function moveimages() {
	return gulp.src('img/**/*.{jpg,svg,png,ico}')
